...
In this folder you will find Code::Blocks project files, source files, and the CImg library.
To use in windows, just double-click the relevant project file, compile in Code::Blocks, and run.


--------------------------------------------------------------------------------


The CImg licensing information follows.
